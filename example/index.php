...
<head>
    ...
    <title>AdminLTE 2 | PyntaxDAO</title>

    <?php
    $htmlFactory->printCSSFiles(\Pyntax\Html\HtmlFactory::FilePlacementOption_Header);
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">PyntaxDAO</h3>
                </div>
                <div class="box-body">
                    <h4>Adding autoload.php which will autoload all the classes.</h4>
                    <pre>
include "../vendor/autoload.php";
\Pyntax\PyntaxDAO::start();
                    </pre>
                    <h4>Loading HTML Factory object:</h4>
                    <pre>$htmlFactory = \Pyntax\PyntaxDAO::loadHtmlFactory();</pre>
                    <h4>Registring CSS/JS assets we should be loaded on page load.</h4>
<pre>\Pyntax\Config\Config::writeConfig('html', array(
    /**
